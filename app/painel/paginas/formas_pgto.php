...
//totalizar páginas
$query2 = $pdo->query("SELECT * from $pag where nome like '%$buscar%' order by id desc");
...
<div class="page-content header-clear-medium">
  ...
  <div class="card card-style" id="listar">
    <div class="content">
      ...
      <?php
      $query = $pdo->query("SELECT * from $pag where nome like '%$buscar%'  order by id desc LIMIT $limite, $itens_pag");
        ...
        <div class="splide__track">
          <div class="splide__list">
            <div class="splide__slide mx-3">
              <div class="d-flex">
                <div>
                  <h6 class="mt-1 mb-0">{$nome}</h6>
                  <p class="font-10 mt-n1 color-red-dark">Taxa: {$taxa}%</p>
                </div>
            ...
            <div class="splide__slide mx-3">
              <div class="d-flex">
                <div class="ms-auto">
                  <a onclick="editar('{$id}','{$nome}','{$taxa}')"  href="#" class="icon icon-xs rounded-circle shadow-l bg-twitter"><i
  ...
  <div class="content mb-0">
    <div class="d-flex pb-2">
      ...
      <div class="align-self-center ms-auto">
        <button onclick="limparCampos()" style="border: none; background: transparent; margin-right: 12px" data-bs-dismiss="offcanvas"
    ...
    <form id="form" method="post" class="demo-animation needs-validation m-0">
      <div class="row">
       ...
       <div class="form-floating mb-3 position-relative">
        ...
        <label for="nome" class="color-theme ps-5">Forma PGTO</label>
        ...
        <input type="text" class="form-control rounded-xs ps-5" id="taxa" name="taxa" placeholder="">
        <label for="taxa" class="color-theme ps-5">Taxa</label>
      </div>
        </div>
      </div>
